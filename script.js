...
async function loadData() {
    ...
    try {
        ...
        rows.forEach((row, i) => {
            ...
            const weekClass = weekCounter % 2 === 0
                ? "week-even"
                : "week-odd";
            ...
            row.forEach((cell, j) => {
                ...
                if (i === 0) {
                    if (j === 0) {
                        ...
                        /*
                         * Imiona są pobierane z arkusza.
                         * Nie ma tutaj żadnych wpisanych na stałe imion.
                         */
                        const nameColors = [
                            "",
                            "",
                    ...
                    const rowDatePart = row[1]
                        ? row[1].split("-")
                        : null;

                    const rowMonth = rowDatePart
                        ? rowDatePart[1]
                        : null;
...
function initSmartMarquee() {
    ...
    spans.forEach(span => {
        ...
        if (span.offsetWidth > box.offsetWidth) {
            ...
            const distance =
                span.offsetWidth - box.offsetWidth + 25;
